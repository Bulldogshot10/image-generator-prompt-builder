...
- **steroid**: prompt production-ready super detail dengan model-specific hacks, negative constraints, reference strategy, optional variants, dan revision prompt.
